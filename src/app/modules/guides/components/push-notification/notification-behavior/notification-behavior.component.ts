...
@Component({
  selector: 'pwa-notification-behavior',
  templateUrl: './notification-behavior.component.html',
  styleUrls: ['./notification-behavior.component.css']
})
export class NotificationBehaviorComponent implements AfterViewInit{
    ...
    ngAfterViewInit(){
        this.communication.sendResource({type : 'resource', appHeader : 'Поведение оповещения', localData : { appAnchors : this.appAnchors, localMenu : this.localMenu}})
    }
